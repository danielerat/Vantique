...
<div class="page-checkout-confirm my-5">
    <div class="mt-5 vertical-center">
        <div class="mt-5 text-center">
            <h1>Thank you!</h1>
            <h5>Your Order Have Been Placed Successfully ,</h5>
            <h5>If you haven't received a confirmation email yet. click
                <button data-toggle="modal" data-target="#receipt"> here to download the receipt</button>.
            </h5>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <div class="w-75 mx-auto" id="invoice">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a target="_blank" href="#">
                                            <img src="images/logo2.png" class='w-25' data-holder-rendered="true" />
                                        </a>
                                    </div>
                            ...
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        ...
                                        <div class="address">CST KN32 ST ,Near CST(UR)</div>
                                        <div class="email"><a
                                                href="mailto:<?php echo $user->email; ?>"><?php echo $user->email; ?>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <table class="mx-auto" border="0" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <h3>
                                                    <a target="_blank"
                                                        href="view-product.php?id=<?php echo h($p->id); ?>"
                                                        target="_blank">
                                ...
                                <div class="notices">
                                    <div>NOTICE:</div>
                                    <div class="notice">If you need Anything changed on your order or address,feel free
                                        to reach
                                        us...
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button id="printInvoice" type="button" class="btn btn-primary">Print</button>
