...
{
    static protected $table_name = 'productSubCategory';
    static protected $db_columns = ["id", "productId", "subCategoryId"];
    ...
    public function __construct($args = [])
    {
        ...
        $this->subCategoryId = $args['subCategoryId'] ?? '';
    }
    ...
    static public function count_product_by_cat($categoryId)
    {
        ...
        $sql .= " WHERE subCategoryId ='" . self::$db->escape_string($categoryId) . "';";
